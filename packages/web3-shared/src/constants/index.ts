...
import ZoraAPI from '@masknet/web3-constants/data/zora-api.json'
...
export const getZoraAPIConstants = transform(ZoraAPI)
export const useZoraAPIConstants = hookTransform(getZoraAPIConstants)
